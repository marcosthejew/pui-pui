        ...
        <h1> Modificar Persona</h1></div>
         ...
         <table style="margin:auto;" border="0" cellspacing="10" cellpadding="10" >
                ...
                <tr>
                    ...
                    <td class="auto-style2">
                        <asp:TextBox ID="LFechaIngreso" runat="server" Height="21px" Width="272px" Enabled="false"></asp:TextBox>
                    </td>
                </tr>
                     <tr>
               ...
               <tr>
                    ...
                    <td class="auto-style2">
                        <asp:TextBox ID="LTelefonoCelular" runat="server" Height="21px" Width="272px" MaxLength="50"></asp:TextBox>
                    </td>
                    <td class="auto-style6">Telefono Local</td>
                    <td class="auto-style2">
                        <asp:TextBox ID="LTelefonoLocal" runat="server" Height="21px" Width="272px" MaxLength="50"></asp:TextBox>
                    </td>
                </tr>
                <tr>
               ...
               <tr>
                ...
                <tr>
                    ...
                    <td class="auto-style2"colspan="3">
                        <asp:TextBox ID="LDireccion" runat="server" Height="21px" Width="272px" MaxLength="50"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                  ...
                  <tr>
                    <td colspan="4" align="center">
                        <asp:Button ID="BRegistrar" runat="server" CssClass="button" onclick="BRegistrar_Click" Width="120" Height="25" Text="Guardar" />
                    </td>
                </tr>
             </table>
