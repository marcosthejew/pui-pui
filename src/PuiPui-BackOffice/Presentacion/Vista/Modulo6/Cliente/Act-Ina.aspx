<%@ Page Title="" Language="C#" MasterPageFile="../../../MasterPage/Site.master"
  AutoEventWireup="true" CodeBehind="Act-Ina.aspx.cs" Inherits="PuiPui_BackOffice.Presentacion.Vista.Modulo6.Cliente.Act_Ina" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

<asp:GridView ID="GridActivarDesactivar" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                CellPadding="4" CssClass="nada" ForeColor="#333333" GridLines="None" HorizontalAlign="Center"
                OnPageIndexChanging="GridActivarDesactivar_PageIndexChanging" OnSelectedIndexChanged="GridActivarDesactivar_SelectedIndexChanged"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="estadoPersona" HeaderText="Status" />
                </Columns>
