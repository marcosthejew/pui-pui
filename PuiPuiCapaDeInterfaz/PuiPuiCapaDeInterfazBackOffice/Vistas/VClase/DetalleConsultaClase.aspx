...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div  style="float:left;">
        ...
        <legend style="text-align:center; font-family:Helvetica; font-size:14px;"><h2>Detalle Evaluacion Instructor</h2></legend>       
            ...
            <tr>
                <td class="auto-style7" align="left">
                    <asp:Label ID="Label4" runat="server" Text="Label"><h3>Nombre del instructor:</h3></asp:Label>
                </td>
                <td class="auto-style8" align="left">
                    <asp:TextBox ID="nombreEvaInstActual" runat="server" Height="22px" Width="270px" Enabled="False"
                      ></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="auto-style8" align="left">
                    <asp:TextBox ID="Fecha" runat="server" Height="22px" Width="270px" Enabled="False"
                      ></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="auto-style2" colspan="0" align="left">
                    <asp:TextBox id="Observacion" runat="server" Wrap="true" TextMode="MultiLine" Enabled="False" Width="200px" Height="115px"></asp:TextBox>
                </td>    
            </tr>
