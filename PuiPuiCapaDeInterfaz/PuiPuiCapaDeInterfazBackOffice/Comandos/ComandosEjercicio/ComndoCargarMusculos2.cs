...
{
    public class ComndoCargarMusculos2: AComando<bool>
    {
        IContratoDesactivarMusculo _vista;


        public ComndoCargarMusculos2(IContratoDesactivarMusculo vista)
        {
            _vista = vista;
        }
        public override bool Ejecutar()
        {
            ...
            foreach (XmlElement nodo in nodoListaMusculo)
            {
                ...
                {
                    (_vista as VistaDesactivarMusculo).ComboMusculo.DataTextField = id[0].InnerText;
                    (_vista as VistaDesactivarMusculo).ComboMusculo.DataTextField = nombre[0].InnerText;
                    (_vista as VistaDesactivarMusculo).ComboMusculo.Items.Insert(i, nombre[0].InnerText);
                }
