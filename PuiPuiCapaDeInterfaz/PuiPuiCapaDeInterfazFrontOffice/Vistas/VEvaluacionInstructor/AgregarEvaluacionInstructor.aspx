<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/PuiPuiCapaDeInterfazFrontOffice.Master" AutoEventWireup="true" CodeBehind="AgregarEvaluacionInstructor.aspx.cs" Inherits="PuiPuiCapaDeInterfazFrontOffice.Vistas.VEvaluacionInstructor.AgregarEvaluacionInstructor" %>
        ...
        <fieldset style="width: 775px; height: auto; margin-left: 7.5%; fit-position: center;">
            ...
            <table style="margin: 5% auto auto 22%; height: 140px; width: 422px;" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td class="auto-style8" align="left">
                        <asp:TextBox ID="Fecha" runat="server" Height="22px" Width="270px" ></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style7" align="left">
                ...
                <tr>
                    ...
                    <td class="auto-style6" colspan="0" align="center">
                        <asp:Button ID="botonModificar" runat="server" Text="Crear" CssClass="button" Font-Names="Tomoha Plain" Font-Size="14px" Height="25px" Width="120px" OnClick="botonModificar_Click" />
                    </td>
